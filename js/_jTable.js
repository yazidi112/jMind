...
var jTable=function(data,options,func){  
					...
					$(element).empty().html(j_loading);
		 			 $.post(url+"/do/jTable_do.php",{  
		 					...
		 					search: search
		 						 	...
		 						 	$(element).append("<div class='msgbox'></div><table data-name="+entite+"></table>");
		 							...
		 							var tr="";
		 							if(hiddenLabels===undefined || hiddenLabels==false){
			 							   tr+="<thead><tr>";
