...
var jView=function(data,options){  
					...
					var formOptions=options.formOptions;
 					var style=options.style===undefined?true:options.style;
					var head=options.head===undefined?true:options.head;
					...
					$(element).empty().html(j_nodata);
		 			 $.post(url+"/do/jTable_do.php",{  
		 					...
		 					search: search
		 						 	...
		 						 	$(element).append("<div class='msgbox'></div>");
		 						 	$(element).append("<table data-name="+entite+"></table>");
		 							...
		 							if(head){
			 							   ...
			 							   if(labels===undefined){
			 						 	    ...
			 						 	    if(action.delete || action.update)tr+="<th></th>";
			 						 	     	tr+="</tr></thead>";
		 					 		}
		 						 ...
		 						 for(var i=0;i<total;i++){
		 								 	...
		 								 	if(action.update)tr+="<td class=update data-id="+arr[0]+"><a href='#'><img src='"+url+"/images/edit.png' style='width:20px;height:20px' /></a></td>";
		 								 	if(action.delete)tr+="<td class=delete data-id="+arr[0]+"><a href='#'><img src='"+url+"/images/delete.png' style='width:20px;height:20px' /></a></td>";
		 								 	tr+="</tr>";
